...
public class CurrencyController {
	 ...
	 * 
	 * @return The response entity including the location of the newly created currency.
	 */
	 ...
	 * 
	 * @return Page instance containing list of currencies adhere to the page information.
	 */
	...
	/**
	 * Gets the currency when it is found by the given ticker. When no currency could
	...
	/**
	 * Updates the currency by given ticker with the body information and return a 'No content'
	 * response. When a currency is not found a 'Not found' response will be given.
	 * 
	 * @param body The body containing the request data.
	...
	/**
	 * Deletes the currency when it is found by the given ticker. When no currency could
	 * be found an exception will be thrown. 
	 * 
